...
class EnsembleCentralServerTest {
    ...
    @Test
    void createEnsembleHybridSplit() throws Exception {
        ...
        List<WebNode> network1 = networks.get(0).getNodes();
        List<WebNode> network2 = networks.get(1).getNodes();
        List<WebNode> network3 = networks.get(2).getNodes();
        ...
        assertEquals(network1.get(0).getProbabilities().get(0).getP(), 0.39, 0.01);
